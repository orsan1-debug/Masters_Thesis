# run_overlap_axis_1000reps__ov_1k.R: overlap axis rerun, c_prop {6, 8, 16}, sigma_y = 1, lasso,
# maxit 1e5, 1000 reps. From balnet_mini_experiment_edited.R lines 1146-1195.
# Writes results/runs/ov_1k_<ii>_r1000.rds (no figure; plotted by plot_rmse_grids_for_qmd.R).
...
for (i in seq_len(nrow(grid))) {
  out_file <- file.path(res_dir, sprintf("ov_1k_%02d_r%d.rds", i, n_rep))
