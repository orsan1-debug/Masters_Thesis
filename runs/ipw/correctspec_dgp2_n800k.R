...
res_cor <- run_batch(dgp_gen(FALSE), grid,
                     num_sim   = 1000,
                     base_seed = 202,
                     out_file  = here::here("results", "ipw", "correctspecDGP200k.csv.gz"),
...
res_cor_400k <- run_batch(dgp_gen(FALSE), grid400,
                          num_sim   = 1000,
                          base_seed = 203,
                          out_file  = here::here("results", "ipw", "correctspecDGP400k.csv.gz"),
...
res_cor_800k <- run_batch(dgp_gen(FALSE), grid800,
                          num_sim   = 1000,
                          base_seed = 204,
                          out_file  = here::here("results", "ipw", "correctspecDGP800k.csv.gz"),
